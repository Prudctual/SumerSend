...
import { Wallet, Plus, Clock, Shield, AlertCircle, ArrowUpRight, BarChart3, Settings, CreditCard, Download, CheckCircle2, Mail, MessageSquare, Phone, Zap } from 'lucide-react';
...
export const BillingView: React.FC<BillingViewProps> = ({
  ...
  return (
    <ScrollReveal>
      ...
      {showGuide && (
        <BentoCard className="card" style={{ marginBottom: '20px', padding: '24px', backgroundColor: 'var(--panel-bg)', borderRadius: '16px', border: '1px solid var(--border-color)', boxShadow: 'var(--card-shadow)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '12px' }}>
            <div style={{ padding: '16px', borderRadius: '12px', backgroundColor: 'rgba(0, 112, 243, 0.05)', border: '1px solid rgba(0, 112, 243, 0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <div style={{ padding: '8px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}><Mail size={18} color="#0070f3" /></div>
            ...
            <div style={{ padding: '16px', borderRadius: '12px', backgroundColor: 'rgba(16, 185, 129, 0.05)', border: '1px solid rgba(16, 185, 129, 0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <div style={{ padding: '8px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}><MessageSquare size={18} color="#10b981" /></div>
            ...
            <div style={{ padding: '16px', borderRadius: '12px', backgroundColor: 'rgba(245, 158, 11, 0.05)', border: '1px solid rgba(245, 158, 11, 0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <div style={{ padding: '8px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}><Phone size={18} color="#f59e0b" /></div>
